...
// Sample user data
const users = [
	{ id: "67691a68654794f74316bd08", username: "JohnDoe", balance: 1000 },
...
const bets = [
	{
		id: "B1",
		userId: "67691a68654794f74316bd08",
		gameId: "G1",
		betType: "winner",
		pick: "home",
		amount: 50,
...
function simulateBetPlacement({
	...
	const newBet = {
		...
		pick,
		amount,
		potWin: Number(odds.toFixed(2)) * amount,
...
export { liveGameData, users, bets, generateLiveUpdate, simulateBetPlacement };
